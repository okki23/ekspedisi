        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form role="form" method="post" id="frmdivisi" action="<?php echo base_url($this->router->fetch_class() . '/process_store_divisilist'); ?>">

                        <div class="form-group">
                            <label>Divisi</label>
                            <input type="hidden" name="id" class="form-control input-divisi" value="<?php echo $list['id']; ?>">
                            <input type="text" name="divisi" id="divisi" class="form-control input-divisi" value="<?php echo $list['divisi']; ?>" placeholder="Divisi Name">
                        </div>

                        <div class="form-group">
                            <label>Description</label>
                            <textarea name="ket_divisi"class="form-control input-divisi" placeholder="Description"><?php echo $list['ket_divisi']; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label>Status</label>
                            <select name="u_status" class="form-control input-divisi">
                        ...
                        <div class="btn-group">
                            ...
                            <a class="btn btn-shadow btn-danger" href="<?php echo base_url($this->router->fetch_class() . "/call_divisilist"); ?>">Cancel</a>
                        </div>
...
<textarea id="dtaccess" style="display: none;"><?= $list['access_divisi']; ?></textarea>
