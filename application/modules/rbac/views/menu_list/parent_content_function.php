...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if ($("#pcontent").hasClass("sapTable")) {
            ...
            $("#pcontent").sapTable({
                ...
                formatters: {
                    "option": function () {
                        return "<a href='javascript:void(0)' class='btn btn-warning btn-xs' onclick='selectData( " + rows.id + ",\"" + rows.u_function_name + "\");return false;'>Select</a>"
                    }
                }
            });
        }
    ...
    function selectData(id, ufunction) {
        //alert(id);
        $("#u_function_list_id").val(id);
        $("#u_function").val(ufunction);
        $(".modal").modal('hide');
    }
