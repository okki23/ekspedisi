...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function grabdata() {
            ...
            $("#tbl-customer-pic").refresh_sapTable({
                url : "<?php echo base_url('master/customer/pic_customer_json/'); ?>" + code_customer
            });
            return false;
        } else {
            $("#tbl-customer-pic").sapTable({
                ...
                cSearch: {
                    'a.customer_pic_name': 'Name',
                    'b.position_name': 'Position',
                    'a.customer_pic_phone': 'Phone',
                    'a.customer_pic_email': 'Email'
                },
                formatters: function () {
    ...
    $("#savepic").click(function () {
        ...
        if(customer_pic_id == ''){
           ...
           url =  "<?php echo base_url('master/customer/pro_store_pic'); ?>";
        }else{
           
           url =  "<?php echo base_url('master/customer/pro_update_store_pic'); ?>";
        }
    ...
    function editPIC(custCode, emailPIC) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url('master/customer/get_data_pic'); ?>",
            data: dt,
            dataType: 'json',
            success: function (hasil) {
    ...
    function delPIC(custCode, emailPIC) {
        ...
        if (result) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url('master/customer/delete_pic_customer'); ?>",
                data: dt,
                dataType: 'json',
                success: function (hasil) {
                    if (hasil.success == true) {
