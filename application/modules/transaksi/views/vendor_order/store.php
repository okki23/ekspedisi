                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                            <ul>
                                                <li style="text-decoration:underline;">Vendor Order Data</li>
                                            </ul>
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                            <ul>
                                                <li style="text-decoration:underline;"> Vendor Order Transaction</li>
                                            </ul>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-6"> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label> Vendor Order Code</label>
                                                                        <input type="text" name="vendor_order_code" id="vendor_order_code" readonly="readonly"  class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <div class="col-lg-12">
                                            <table class="table">
                                                <tr align="center" style="font-weight: bold;">
                                                    <td> Vendor Over Weight (Kg)</td>
                                                    <td> Vendor Over Price Weight (Rp)</td>
                                                    <td> Overnight (Day)</td>
                                                    <td> Price Overnight (Rp)</td>
                                                </tr>
                                                <tr>
                                                    <td><input type="text" name="vendor_over_weight" id="vendor_over_weight" value="<?php echo $list->vendor_over_weight; ?>"   class="form-control" > </td>
                                                    <td><input type="text" name="vendor_orver_price_weight" id="vendor_orver_price_weight"  value="<?php echo $list->vendor_orver_price_weight; ?>" class="form-control" ></td>
...
<script type="text/javascript">
    ...
    $("#province").on("change", function () {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/vendor_order/get_island_single') ?>",
            type: "POST",
            data: {data: datapos},
    ...
    $("#type_service").on("change", function () {
        ...
        if (ts == '') {
            ...
            $("#list_ltl").hide();
            $("#lmd").show();
            get_list_po_fix_multi(soprimary);
        } else if (ts == 'ltl') {
            $("#ists").val($(this).val());
            $("#f_lead_time").hide();
            $("#list_ftl").hide();
        ...
        if (charge_option_sub == 'free') {
            ...
            if (island_params == 'Java' && island_multi == 'Java') {
                ...
                if (districtparams == districtsub) {
                    $.ajax({
                        url: "<?php echo base_url('transaksi/vendor_order/get_mdjsc'); ?>",
                        type: "POST",
                    ...
                    $.ajax({
                        url: "<?php echo base_url('transaksi/vendor_order/get_mdjdc'); ?>",
                        type: "POST",
                        data: {custcode: custcode, vehicle_params: vehicle_params, island_multi: island_multi, districtsub: districtsub},
                ...
                if (districtparams == districtsub) {
                    $.ajax({
                        url: "<?php echo base_url('transaksi/vendor_order/get_mdssc'); ?>",
                        type: "POST",
                        data: {custcode: custcode, vehicle_params: vehicle_params, island_multi: island_multi, districtsub: districtsub},
                    ...
                    $.ajax({
                        url: "<?php echo base_url('transaksi/vendor_order/get_mdsdc'); ?>",
                        type: "POST",
                        data: {custcode: custcode, vehicle_params: vehicle_params, island_multi: island_multi, districtsub: districtsub},
    ...
    function get_multidrop(data) {
        $.get("<?php echo base_url('transaksi/vendor_order/get_edit_so_fix/'); ?>" + data, function (resp) {
    ...
    function get_edit_so_fix_multi(query) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/vendor_order/get_edit_so_fix_multi/'); ?>" + query,
            type: "GET",
            success: function (list) {
                var obj = JSON.parse(list);
    ...
    function get_list_po_fix_multi(soprimary) {

        $.getJSON("<?php echo base_url('transaksi/vendor_order/get_list_po_fix_multi/'); ?>" + soprimary, function (data) {
            var items = [];
            $('#example tbody').empty();
            var iSum = 0;
            var no = 0;
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/vendor_order/get_id_pic_vendor/'); ?>" + custcode + "",
            type: "GET",
            success: function (response) {
                console.log(response);
