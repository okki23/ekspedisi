...
<div class="col-md-12 col-xs-12">
    ...
    <button type="button" class="btn btn-success" id="refreshvhc">Refresh</button>
    ...
    <div class="panel-body">
        <section id="flip-scroll">
            <table class="table table-bordered table-striped cf" id="tbl-vendor-vehicle">
                <thead class="cf">
                    <tr>
                        <th data-options="vendor_vehicle_no">Vehicle No.</th>
                        <th data-options="vendor_vehicle_type">Vehicle Type</th>
                        <th data-options="name_vehicle">Vehicle Sub Type</th>
