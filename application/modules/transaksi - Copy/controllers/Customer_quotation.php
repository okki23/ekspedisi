...
class Customer_quotation extends Parent_Controller {
    ...
    public function index() {
        ...
        if ($search == '') {
            $data['customer_quotations'] = $this->customer_quotation_m->get_no_search($per_page)->result();
            //$data['total_rows'] = $this->customer_quotation_m->count_thread($search, $list_cari);
        } else {
            $data['customer_quotations'] = $this->customer_quotation_m->get_with_search($per_page, $list_cari)->result();
            //$data['total_rows'] = $this->customer_quotation_m->count_thread($search, $list_cari);
        }
