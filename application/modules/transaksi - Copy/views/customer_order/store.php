        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <section class="panel">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                            <ul>
                                                <li style="text-decoration:underline;">Customer Order Data</li>
                                            </ul>
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                            <ul>
                                                <li style="text-decoration:underline;"> Customer Order Transaction</li>
                                            </ul>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-6"> 
                                                                    <input type="hidden" name="idsofix" id="idsofix">
                                                                    <div class="form-group">
                                                                        <label> Customer Order Code</label>
                                                                        <input type="text" name="sales_order_code" id="sales_order_code" readonly="readonly"  class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="hidden" name="ists" id="ists">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="service_mode" class="form-control" id="service_mode">
                                                                            <option value="">--</option>
                                                                    ...
                                                                    <div id="list_ltl">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" id="tot_satuan" name="tot_satuan">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label> Satuan </label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div id="lmd">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <br>
                                                                        <div class="col-md-6">
                                                                            <button type="button" id="savemodal_sub" class="btn btn-block btn-primary">Save Multidrop</button>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <button type="button" id="cancelmodal_sub" class="btn btn-block btn-primary">Cancel Multidrop </button>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <hr>
                                                                <br>
                                                                <button type="button" id="savemodal" class="btn btn-block btn-primary">Save</button>
                                                                <button type="button" id="cancelmodal" class="btn btn-block btn-primary">Cancel</button>
                                                            </div>
                ...
                <div align="center">
                    ...
                    <a href="<?php echo base_url('transaksi/customer_order'); ?>" class="btn btn-warning" > Cancel </a>
...
<script type="text/javascript">
    ...
    $("#province").on("change", function () {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_island_single') ?>",
            type: "POST",
            data: {data: datapos},
    ...
    $("#type_service").on("change", function () {
        ...
        var soprimary = $("#sales_order_code").val();
        ...
        if (ts == '') {
            ...
            $("#list_ltl").hide();
            $("#lmd").show();
            get_list_so_fix_multi(soprimary);
        } else if (ts == 'ltl') {
            $("#ists").val($(this).val());
            $("#f_lead_time").hide();
            $("#list_ftl").hide();
        ...
        if (charge_option_sub == 'free') {
            ...
            if (island_params == 'Java' && island_multi == 'Java') {
                ...
                if (districtparams == districtsub) {
                    $.ajax({
                        url: "<?php echo base_url('transaksi/customer_order/get_mdjsc'); ?>",
                        type: "POST",
                    ...
                    $.ajax({
                        url: "<?php echo base_url('transaksi/customer_order/get_mdjdc'); ?>",
                        type: "POST",
                        data: {custcode: custcode, vehicle_params: vehicle_params, island_multi: island_multi, districtsub: districtsub},
                ...
                if (districtparams == districtsub) {
                    $.ajax({
                        url: "<?php echo base_url('transaksi/customer_order/get_mdssc'); ?>",
                        type: "POST",
                        data: {custcode: custcode, vehicle_params: vehicle_params, island_multi: island_multi, districtsub: districtsub},
                        success: function (valmdssc) {
                            //console.log(valmdjsc);
                            var obj = JSON.parse(valmdssc);
                            $("#price_sub").val(obj.mdssc);
                        }
                    });
                    //mdssc
                    ...
                    $.ajax({
                        url: "<?php echo base_url('transaksi/customer_order/get_mdsdc'); ?>",
                        type: "POST",
                        data: {custcode: custcode, vehicle_params: vehicle_params, island_multi: island_multi, districtsub: districtsub},
                        success: function (valmdsdc) {
                            //console.log(valmdjsc);
                            var obj = JSON.parse(valmdsdc);
                            $("#price_sub").val(obj.mdsdc);
                        }
                    });
                    //mdsdc
    ...
    function get_detail_so_fix(data) {
        ...
        $("#myModal3").modal('show');
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_detail_so_fix/') ?>" + data,
            type: "GET",
    ...
    function get_origin_sub(custcode) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_origin/'); ?>" + custcode + "",
    ...
    function get_vehicle_sub(custcode) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_vehicle/'); ?>" + custcode + "",
    ...
    function get_province_sub(custcode) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_province/'); ?>" + custcode + "",
    ...
    function get_district_sub(custcode) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_district/'); ?>" + custcode + "",
    ...
    function get_multidrop(data) {
        $.get("<?php echo base_url('transaksi/customer_order/get_edit_so_fix/'); ?>" + data, function (resp) {
    ...
    function get_edit_so_fix(query) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_edit_so_fix/'); ?>" + query,
            type: "GET",
            success: function (list) {
                ...
                $("#sc").val(obj.sc);
                $("#moda").val(obj.moda);
                $("#service_mode").val(obj.service_mode);
            ...
            $("#vehicle_paramsx").html(obj.vehicle);
                ...
                if (tsrv == 'ftl') {
                    ...
                    $("#f_lead_time").show();
                     ...
                     $.get("<?php echo base_url('transaksi/customer_order/get_params_multidp/'); ?>" + obj.sales_order_code, function (resp) {
            var row = JSON.parse(resp);
            //get_list_so_fix_multi(row.id);
            $("#soparent").val(row.id);
            $("#origin_sub").val(row.origin);
            ...
            console.log(resp);
                    ...
                    get_list_so_fix_multi(obj.sales_order_code);
                    $("#lmd").show();
    ...
    function get_delete_so_fix(query) {
        var custcode = $("#customer_code").val();
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_delete_so_fix/'); ?>",
            type: "POST",
            data: {query: query},
            success: function (list) {
    ...
    function get_delete_so_fix_multi(query) {
        var custcode = $("#customer_code").val();
         var soprimary = $("#sales_order_code").val();
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_delete_so_fix_multi/'); ?>" + query,
            type: "GET",
    ...
    function get_edit_so_fix_multi(query) {
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_edit_so_fix_multi/'); ?>" + query,
            type: "GET",
            success: function (list) {
                var obj = JSON.parse(list);
    ...
    $("#pph").change(function () {
        ...
        var total = parseInt($("#amount_sales").val());
    ...
    $("#calculate_amount_debt").on("click", function () {
        ...
        var netto_sales = parseInt($("#amount_sales").val());
        var operate = netto_sales - amount_dp;
        $("#total_amount_debt").val(operate);

    });
    function get_list_so_fix_multi(soprimary) {

        $.getJSON("<?php echo base_url('transaksi/customer_order/get_list_so_fix_multi/'); ?>" + soprimary, function (data) {
            var items = [];
            $('#example tbody').empty();
            var iSum = 0;
            var no = 0;
    ...
    $(document).ready(function () {
        ...
        $("#news").on("click", function () {
            ...
            */
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('transaksi/customer_order/get_so_code'); ?>",
                dataType: "json",
                data: {code: custcode},
        ...
        $("#sc").on("change",function(){
           ...
           var moda = $("#moda").val();
           $.ajax({
                    url:"<?php echo base_url('transaksi/customer_order/get_val_ltl');?>",
                    data:{uom: kons,
        ...
        $("#savemodal").on("click", function () {
            ...
            $.ajax({
                url: "<?php echo base_url('transaksi/customer_order/save_qc_of_so'); ?>",
                type: "POST",
        ...
        $("#savemodal_sub").on("click", function () {
            ...
            $.ajax({
                url: "<?php echo base_url('transaksi/customer_order/save_qc_of_so_multi'); ?>",
                type: "POST",
        ...
        $.ajax({
            url: "<?php echo base_url('transaksi/customer_order/get_id_pic_customer/'); ?>" + custcode + "",
            type: "GET",
            success: function (response) {
                console.log(response);
        ...
        $.get('<?php echo base_url('transaksi/customer_order/get_val_pic_phone/') ?>' + val_pic_customer, function (data) {
        ...
        $("#id_pic_customer").on("change", function () {
            var datax = $(this).val();
            $.get('<?php echo base_url('transaksi/customer_order/get_val_pic_phone/') ?>' + datax, function (data) {
                var konten = JSON.parse(data);
                $("#pic_customer_phone").val(konten.customer_pic_phone);
                //console.log(konten.customer_pic_phone);
            });
        ...
        $("#id_traffic_name").on("change", function () {
            ...
            $.ajax({
                url: "<?php echo base_url('transaksi/customer_order/get_traffic_phone/'); ?>" + data,
                type: "GET",
                //data:{data:data},
                //datatype:"json",
                success: function (data) {
        ...
        var getdata = new Bloodhound({
            ...
            remote: {
                url: '<?php echo base_url('transaksi/customer_order/get_customer_name_json?query=%QUERY'); ?>',
                wildcard: '%QUERY'
            }
        });
        ...
        $('#remote .typeahead').bind('typeahead:selected', function (obj, datum, name) {
            ...
            $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('transaksi/customer_order/get_coi_code'); ?>",
                    dataType: "json",
                    data: {code: datum.customer_code},
                    success: function (result) {
                        console.log(result);
                    $('#customer_order_index').val(result);
                    },
                    async: false
                   });
            //get so code
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('transaksi/customer_order/get_pic_phone/'); ?>" + datum.customer_code,
                //dataType: "json",
                //data: {code: datum.customer_code},
                success: function (result) {
                    console.log(result);
        ...
        $("#customer_name").on("focusout", function () {
            ...
            //get si pic
            $.ajax({
                url: "<?php echo base_url('transaksi/customer_order/get_id_pic_customer/'); ?>" + isi + "",
                type: "GET",
                success: function (response) {
                    console.log(response);
                    $("#id_pic_customer").html(response);
        ...
        $("#calculate").on("click", function () {
            ...
            if(type_service == 'ftl'){
                    ...
                    $("#lead_time").val(0 + ' Days');
                        ...
                        $.ajax({
                            url: "<?php echo base_url('transaksi/customer_order/calculating_qso_ftl'); ?>",
                            type: "POST",
                    ...
                    $.ajax({
                             url:"<?php echo base_url('transaksi/customer_order/get_call_ltl');?>",
                             data:{ 
                                   custcode:custcode,
                                   island:island_single,
                                   origin: origin,
