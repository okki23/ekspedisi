    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="sales_order_status" class="form-control">
                                                    <option value="">--</option>
                                                    <option value="open" <?php
                                                    if ($list->sales_order_status == 'open') {
                                                        echo "selected=selected";
                                                    }
                                                    ?> >Open</option>
                                                    <option value="close" <?php
                                                    if ($list->sales_order_status == 'close') {
                                                        echo "selected=selected";
                                                    }
                                                    ?> >Close</option>
                                                </select>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="province_params" id="province_params" class="form-control">
                                                            <input type="text" name="district_params" id="district_params" class="form-control"> 
                                                            <input type="text" name="island_params" id="island_params" class="form-control">
            ...
            <script type="text/javascript">
                ...
                $("#province_sub").on("click",function(){
                ...
                function get_list_so_fix(codecust) {
                    ...
                    $.getJSON("<?php echo base_url('transaksi/sales_order/get_list_so_fix/'); ?>" + codecust, function (data) {
                        ...
                        $.each(data.data, function (key, val) {
                            ...
                            items.push("<td>" + val.district_info + "</td>");
                            /* 
                            <th> Main Price </th> harga utama 
                            <th> Multidrop Price </th> harga multidrop
                            <th> Grand Total Price </th> total harga seluruhnya termasuk penjumlahan apabila ada atau tidak multidrop
                            */                                
                            items.push("<td>" + val.price + "</td>");
                ...
                $("#province_sub").on("change",function(){
                    var konten = $("#province_sub").val();
                    console.log(konten.indexOf('Jawa')); 
                });
                var str = 'Hello World';
                var matches = str.match(/price\[(\d+)\]\[(\d+)\]/);
                if(matches == true){
                    console.log('match');
                }else{
                ...
                //alert(pos);
                //var pos2 = str.indexOf('Te',10);
                    $("#cekdata").on("click",function(){
                        
                        var originsub = $("#origin_sub").val();
                        var provincesub = $("#province_sub").val();
                        var districtsub = $("#district_sub").val();
                        var provinceparams = $("#province_params").val();
                        var districtparams = $("#district_params").val();
                        if(provincesub == provinceparams){
                            console.log('same');
                        }else{
                    ...
                    /*
                     ...
                     var email = $("#modalmail").val();
                     var pass = $("#passmail").val();
                     var embed = email + '-' + pass;
                     //$("#myModal").hide();
                     $('#myModal').modal('hide');
                     console.log(embed);
                     });
